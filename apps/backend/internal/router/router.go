...
func NewRouter(s *server.Server, h *handlers.Handlers, repos *repositories.Repositories) *gin.Engine {
	...
	v1.RegisterV1Routes(v1Router, h, mw, repos.SessionRepo, []byte(s.Config.Auth.SecretKey))
